		...
		public function set($key, $value)
		{
			switch($key)
			{
				case 'offset':
						...
						{
							throw new Exception('opcPaginator - Page not found [offset: '.$value.']');
						}
				...
				case 'page':				 
						...
						{
							throw new Exception('opcPaginator - Page not found ['.$value.']');
						}
				...
				case 'decorator':
						if(is_string($value))
						{
							...
							if(!$decoratorClass)
							{
								throw new Exception('opcPaginator - Undefined decorator ['.$value.']');
							}
							...
							{
								throw new Exception('opcPaginator - Given decorator ['.get_class($value).'] is not a subclass of "opcPaginatorDecorator".');
							}
